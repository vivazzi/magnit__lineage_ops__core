...
import { validate_body, validate_params } from '#app/http'

import { lineage_export_input, lineage_task_id_input } from './schemas.ts'
...
export const ROUTES = {
    ...
    LINEAGE_STATUS: '/lineage/:task_id',
    LINEAGE_DOWNLOAD: '/lineage/:task_id/download',
} as const
